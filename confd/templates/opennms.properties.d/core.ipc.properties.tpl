...
{{end -}}
{{if or (and (exists $sink_strategy) (eq (getv $sink_strategy "") ("sqs"))) (and (exists $rpc_strategy) (eq (getv $rpc_strategy "") ("sqs"))) -}}
#
...
{{end -}}
{{if and (exists $rpc_strategy) (eq (getv $rpc_strategy "") ("kafka")) -}}
#
# Kafka RPC Settings
...
{{end -}}
{{end -}}
{{if and (exists $sink_strategy) (eq (getv $sink_strategy "") ("kafka")) -}}
#
# Kafka Sink Settings
...
{{end -}}
{{end -}}
{{if and (exists $rpc_strategy) (eq (getv $rpc_strategy "") ("sqs")) -}}
#
# AWS RPC Settings
...
{{end -}}
{{end -}}
{{if and (exists $sink_strategy) (eq (getv $sink_strategy "") ("sqs")) -}}
#
# AWS Sink Settings
